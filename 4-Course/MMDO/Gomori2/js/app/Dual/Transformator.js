function Transformator($table, $function, $conditions, $inalienability, $direction) {
    ...
    this.processSecondStep = function () {
        ...
        for (var i = 0; i < this._table.length; i++) {
            ...
            if (!this._transformed.showstopper && this._table[i][this._table[i].length - 1].lt(0)) {
                error = false;
                for (var j = 0; j < this._table[i].length - 1; j++) {
                    error |=  (this._table[i][j].lt(0));
                }
            ...
            if (!error) {
                error = true;
                this._transformed.showstopper = true;
            }
        }
    };

    this.processFirstAndHalfStep = function() {
    ...
    this.processFourthStep = function () {
        ...
        var simple = new DualSimplexMethod(this._table, this._function);
