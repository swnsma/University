TableProcessor = (function()
{
    ...
    DualTableProcessor.prototype.buildFirstTable = function(limits, coeficients, basis) {
    ...
    DualTableProcessor.prototype.findMinMax = function(table, basis) {
    ...
    DualTableProcessor.prototype.checkMarks = function(table) {
    ...
    DualTableProcessor.prototype.processNext = function(table, newBasis, basisPos) {
